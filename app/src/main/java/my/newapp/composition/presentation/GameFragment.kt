...
import my.newapp.composition.databinding.FragmentGameBinding
import my.newapp.composition.databinding.FragmentGameFinishedBinding
                ...
                .replace(
                    ...
                    GameFinishedFragment.newInstance(
                        gameResult = GameResult(
                            ...
                            5,
                            5,
                            gameSettings = GameSettings(5, 4, 3, 5)
                        )
                    )
                )
